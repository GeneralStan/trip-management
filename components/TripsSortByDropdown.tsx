...
interface TripsSortByDropdownProps {
...
const sortOptions = [
  ...
  { value: 'Capacity Usage', label: 'Capacity Usage' },
  { value: 'Planned Distance', label: 'Planned Distance' },
];

export default function TripsSortByDropdown({
  selectedOption,
  selectedOrder,
  onSelectOption,
  onSelectOrder,
}: TripsSortByDropdownProps) {
  return (
    <div
